...
//        view.findViewById(R.id.go_to_all_settings_action).setOnClickListener(this);
        ...
        view.findViewById(R.id.go_to_done_action).setOnClickListener(this);
...
//        break;
    ...
    public void onStart() {
        ...
        SetupSupport.popupViewAnimationWithIds(getView(), R.id.go_to_done_action);
